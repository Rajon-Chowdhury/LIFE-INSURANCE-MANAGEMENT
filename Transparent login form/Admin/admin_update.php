...
{
$info = getData();
$search_query="SELECT * FROM admin  WHERE id = '$info[0]'";
...
$info = getData();
$insert_query="INSERT INTO `admin`(`username`, `email`,`password`) VALUES ('$info[1]','$info[2]','$info[3]')";
try{
...
$info = getData();
$delete_query = "DELETE FROM `admin` WHERE id = '$info[0]'";
try{
...
$info = getData();
$update_query="UPDATE `admin` SET `username`='$info[1]',email='$info[2]',password='$info[3]' WHERE id = '$info[0]'";
try{
